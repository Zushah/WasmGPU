...
export { webgpuInterop } from "./wgsl";
export type { BufferResource, BufferBinding, BindingResource, BindGroupResources, BindGroupLayoutDescriptor, StorageBufferBindingLayout, UniformBufferBindingLayout, SamplerBindingLayout, TextureBindingLayout } from "./wgsl";
