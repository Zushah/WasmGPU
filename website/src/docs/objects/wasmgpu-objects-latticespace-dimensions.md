...
- [LatticeSpace.dimensionCount](./wasmgpu-objects-latticespace-dimensioncount.md)
- [LatticeSpace.mapCellIndexToLinear](./wasmgpu-objects-latticespace-mapcellindextolinear.md)
