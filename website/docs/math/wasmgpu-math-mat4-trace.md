# WasmGPU.math.mat4.trace

## Summary
WasmGPU.math.mat4.trace computes the matrix trace (sum of diagonal terms). The trace is used in diagnostics and certain decomposition formulas.
