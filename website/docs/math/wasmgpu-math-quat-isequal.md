# WasmGPU.math.quat.isEqual

## Summary
WasmGPU.math.quat.isEqual checks whether two inputs are equal under the engine's comparison rule. It returns a boolean predicate for fast validation paths.
