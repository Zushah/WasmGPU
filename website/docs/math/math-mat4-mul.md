...
## Summary
math.mat4.mul multiplies a matrix by another matrix or by a 4-component vector. Use it to compose transforms or apply a transform to homogeneous coordinates.
