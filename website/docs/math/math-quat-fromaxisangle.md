...
## Summary
math.quat.fromAxisAngle builds a quaternion from an axis and a radian angle. It is the standard bridge from geometric axis-angle to quaternion rotation.
...
| --- | --- | --- | --- |
| `axis` | `number[]` | Yes | Rotation axis `[x, y, z]`. The function does not normalize it; pass a unit axis to obtain a unit rotation quaternion. |
