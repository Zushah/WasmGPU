...
## Summary
math.mat4.det computes the determinant of a 4x4 matrix. The determinant is commonly used to test invertibility and orientation.
...
```ts
WasmGPU.math.mat4f.det(m: WasmPtr): number
WasmGPU.math.mat4d.det(m: WasmPtr): number
```
...
| --- | --- | --- | --- |
| `matr` | `number[]` | Yes | Column-major 4x4 matrix whose determinant is returned. |
