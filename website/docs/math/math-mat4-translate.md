...
## Summary
math.mat4.translate applies translation to a matrix using a 3D vector. Use it to move objects or coordinate frames in world space.
...
| --- | --- | --- | --- |
| `matr` | `number[]` | Yes | Column-major 4x4 matrix to translate. |
