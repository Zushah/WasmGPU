# WasmGPU.math.vec3.angBetween

## Summary
WasmGPU.math.vec3.angBetween returns the angle between two vectors in radians. This is useful for alignment tests and steering logic.
