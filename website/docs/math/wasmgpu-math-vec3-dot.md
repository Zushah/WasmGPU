# WasmGPU.math.vec3.dot

## Summary
WasmGPU.math.vec3.dot computes the dot product of two vectors. Use it for projection, similarity tests, and lighting calculations.

## Syntax
```ts
WasmGPU.math.vec3.dot(v1: number[], v2: number[]): number
