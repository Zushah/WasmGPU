...
## Summary
math.vec3.proj computes projection of one vector onto another. This operation is central to decomposition and constraint logic.
...
`v1` is projected onto `v2`. If `v2` is the zero vector, the result is `[0, 0, 0]`.
