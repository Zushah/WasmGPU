...
## Summary
math.mat4.rotateX applies rotation around the X axis by a radian angle. Use it to orient models or frames around the horizontal axis.
...
```ts
WasmGPU.math.mat4f.rotateX(out: WasmPtr, m: WasmPtr, angle: number): void
WasmGPU.math.mat4d.rotateX(out: WasmPtr, m: WasmPtr, angle: number): void
```
...
| --- | --- | --- | --- |
| `matr` | `number[]` | Yes | Column-major 4x4 matrix to rotate about the X axis. |
