...
## Summary
math.vec3.neg negates each component of the input. Use it to flip direction or sign while preserving magnitudes.
...
```ts
WasmGPU.math.vec3f.neg(out: WasmPtr, v: WasmPtr): void
WasmGPU.math.vec3d.neg(out: WasmPtr, v: WasmPtr): void
```
