...
## Summary
math.mat4.copy clones the input into a new array. Use it when you want an explicit copy before further edits.

## Syntax
```ts
WasmGPU.math.mat4.copy(matr: number[]): number[]
const result = wgpu.math.mat4.copy(matr);
```

## Precision-Specific Wasm Forms
```ts
WasmGPU.math.mat4f.copy(out: WasmPtr, m: WasmPtr): void
WasmGPU.math.mat4d.copy(out: WasmPtr, m: WasmPtr): void
```
...
| --- | --- | --- | --- |
| `matr` | `number[]` | Yes | Column-major 4x4 source matrix to copy. |
