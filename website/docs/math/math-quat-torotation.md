# math.quat.toRotation

## Summary
math.quat.toRotation rotates a 3D vector by a quaternion. Use it to transform directions without constructing a full matrix.
...
`q` is expected to be normalized. This function does not normalize it before applying the optimized rotation formula.
