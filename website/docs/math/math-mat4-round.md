...
## Summary
math.mat4.round rounds each component to the nearest integer. It is useful when snapping values to a grid or discrete representation.
...
| --- | --- | --- | --- |
| `matr` | `number[]` | Yes | Column-major 4x4 matrix whose 16 elements are rounded. |
