...
## Summary
math.mat4.scl scales the input by a scalar factor. Use it for uniform amplitude, size, or magnitude scaling.
...
| --- | --- | --- | --- |
| `matr` | `number[]` | Yes | Column-major 4x4 matrix whose elements are multiplied by the scalar. |
