...
## Summary
math.quat.neg negates each component of the input. Use it to flip direction or sign while preserving magnitudes.
...
```ts
WasmGPU.math.quatf.neg(out: WasmPtr, q: WasmPtr): void
WasmGPU.math.quatd.neg(out: WasmPtr, q: WasmPtr): void
```
