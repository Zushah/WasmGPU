# WasmGPU.math.vec3.sub

## Summary
WasmGPU.math.vec3.sub computes component-wise subtraction ( - b). It is commonly used for deltas, offsets, and residual computation.

## Syntax
```ts
WasmGPU.math.vec3.sub(v1: number[], v2: number[]): number[]
const result = wgpu.math.vec3.sub(v1, v2);
```

## Precision-Specific Wasm Forms
```ts
WasmGPU.math.vec3f.sub(out: WasmPtr, a: WasmPtr, b: WasmPtr): void
WasmGPU.math.vec3d.sub(out: WasmPtr, a: WasmPtr, b: WasmPtr): void
```
