# WasmGPU.math.quat.sub

## Summary
WasmGPU.math.quat.sub computes component-wise subtraction ( - b). It is commonly used for deltas, offsets, and residual computation.

## Syntax
```ts
WasmGPU.math.quat.sub(q1: number[], q2: number[]): number[]
