# WasmGPU.math.vec3.reflect

## Summary
WasmGPU.math.vec3.reflect reflects an incident vector about a normal-like direction. Use it for bounce directions and mirror responses.
