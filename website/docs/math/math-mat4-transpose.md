...
## Summary
math.mat4.transpose transposes rows and columns of the input matrix. This is useful in linear algebra transforms and normal-matrix workflows.
...
```ts
WasmGPU.math.mat4f.transpose(out: WasmPtr, m: WasmPtr): void
WasmGPU.math.mat4d.transpose(out: WasmPtr, m: WasmPtr): void
```
...
| --- | --- | --- | --- |
| `matr` | `number[]` | Yes | Column-major 4x4 matrix to transpose. |
