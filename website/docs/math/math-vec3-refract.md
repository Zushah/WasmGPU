...
## Summary
math.vec3.refract computes refraction direction from incident and normal vectors with an index ratio. Use it for transmission effects and optics-style vector updates.
...
The operation normalizes `v2`. A nonpositive ratio returns `[0, 0, 0]`; total internal reflection is not handled specially and produces non-finite components.
