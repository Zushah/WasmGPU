# WasmGPU.math.vec3.oproj

## Summary
WasmGPU.math.vec3.oproj computes the orthogonal projection component of one vector relative to another. Use it when separating parallel and perpendicular components.
