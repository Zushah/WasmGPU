...
## Summary
math.mat4.abs returns the component-wise absolute value of the input. Use it to remove sign from each component without changing magnitude ordering.
...
```ts
WasmGPU.math.mat4f.abs(out: WasmPtr, m: WasmPtr): void
WasmGPU.math.mat4d.abs(out: WasmPtr, m: WasmPtr): void
```
...
| --- | --- | --- | --- |
| `matr` | `number[]` | Yes | Column-major 4x4 matrix whose elementwise absolute value is returned. |
