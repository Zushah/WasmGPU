...
## Summary
math.mat4.rotateZ applies rotation around the Z axis by a radian angle. Use it for roll-like rotations in the XY plane.
...
| --- | --- | --- | --- |
| `matr` | `number[]` | Yes | Column-major 4x4 matrix to rotate about the Z axis. |
