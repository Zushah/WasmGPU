# WasmGPU.math.vec3.add

## Summary
WasmGPU.math.vec3.add computes a component-wise sum of two inputs. This is useful for linear accumulation and incremental updates.

## Syntax
```ts
WasmGPU.math.vec3.add(v1: number[], v2: number[]): number[]
const result = wgpu.math.vec3.add(v1, v2);
```

## Precision-Specific Wasm Forms
```ts
WasmGPU.math.vec3f.add(out: WasmPtr, a: WasmPtr, b: WasmPtr): void
WasmGPU.math.vec3d.add(out: WasmPtr, a: WasmPtr, b: WasmPtr): void
```
