...
## Summary
math.mat4.init builds a matrix from explicit component values. Use it when you need exact control of every matrix element.
...
| --- | --- | --- | --- |
| `m0` | `number` | Yes | Flat column-major element 0 (row 0, column 0). |
| `m1` | `number` | Yes | Flat column-major element 1 (row 1, column 0). |
| `m2` | `number` | Yes | Flat column-major element 2 (row 2, column 0). |
| `m3` | `number` | Yes | Flat column-major element 3 (row 3, column 0). |
| `m4` | `number` | Yes | Flat column-major element 4 (row 0, column 1). |
| `m5` | `number` | Yes | Flat column-major element 5 (row 1, column 1). |
| `m6` | `number` | Yes | Flat column-major element 6 (row 2, column 1). |
| `m7` | `number` | Yes | Flat column-major element 7 (row 3, column 1). |
| `m8` | `number` | Yes | Flat column-major element 8 (row 0, column 2). |
| `m9` | `number` | Yes | Flat column-major element 9 (row 1, column 2). |
| `m10` | `number` | Yes | Flat column-major element 10 (row 2, column 2). |
| `m11` | `number` | Yes | Flat column-major element 11 (row 3, column 2). |
| `m12` | `number` | Yes | Flat column-major element 12 (row 0, column 3). |
| `m13` | `number` | Yes | Flat column-major element 13 (row 1, column 3). |
| `m14` | `number` | Yes | Flat column-major element 14 (row 2, column 3). |
| `m15` | `number` | Yes | Flat column-major element 15 (row 3, column 3). |
