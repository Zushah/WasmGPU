# compute.kernels.addF32

## Summary
compute.kernels.addF32 adds two `f32` vectors element by element. It can process a selected prefix, reuse a distinct caller-provided output, or record into an external encoder; otherwise it returns a new readback-capable storage buffer.
