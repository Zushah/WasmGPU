# compute.kernels.minF32

## Summary
compute.kernels.minF32 computes the minimum `f32` value across selected input elements.
...
It inherits `reduceF32`'s count, output, encoder, ownership, and empty-input contracts; an empty selection produces positive infinity.
