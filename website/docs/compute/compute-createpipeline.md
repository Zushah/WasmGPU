...
## Summary
compute.createPipeline builds a compute pipeline from WGSL source and optional explicit bind-group layouts.
...
- [webgpu.bindGroupLayout](../interop/webgpu-bindgrouplayout.md)
