# compute.workgroups1D

## Summary
compute.workgroups1D converts a 1D invocation count into dispatch workgroup counts.
...
## See Also
- [compute.workgroups2D](./compute-workgroups2d.md)
- [compute.workgroups3D](./compute-workgroups3d.md)
