# compute.createPipeline#createBindGroup

## Summary
compute.createPipeline#createBindGroup creates a bind group from high-level buffer resources.
...
## Syntax
```ts
ComputePipeline.createBindGroup(groupIndex: number, resources: BindGroupResources, label?: string): GPUBindGroup
...
## See Also
- [compute.createPipeline#getBindGroupLayout](./compute-createpipeline-getbindgrouplayout.md)
...
- [webgpu.bindGroupResources](../interop/webgpu-bindgroupresources.md)
