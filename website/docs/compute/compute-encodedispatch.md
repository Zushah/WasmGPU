# compute.encodeDispatch

## Summary
compute.encodeDispatch records one compute dispatch into an existing command encoder.
...
## See Also
- [compute.encodeDispatchBatch](./compute-encodedispatchbatch.md)
- [compute.dispatch](./compute-dispatch.md)
- [compute.dispatchBatch](./compute-dispatchbatch.md)
