# compute.kernels.mulC64

## Summary
compute.kernels.mulC64 multiplies complex64 vectors element by element using complex multiplication over interleaved `[real, imaginary]` `f32` pairs. It supports prefix counts, a distinct reusable output, and external command recording; otherwise it returns a new readback-capable storage buffer.
