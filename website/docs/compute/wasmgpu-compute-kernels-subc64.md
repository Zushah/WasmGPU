# WasmGPU.compute.kernels.subC64

## Summary
subC64 computes `a - b` for interleaved `[real, imaginary]` complex64 values.
...
- [WasmGPU.compute.kernels.subU32](./wasmgpu-compute-kernels-subu32.md)
