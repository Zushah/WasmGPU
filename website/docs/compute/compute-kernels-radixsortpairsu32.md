# compute.kernels.radixSortPairsU32

## Summary
compute.kernels.radixSortPairsU32 stably sorts `u32` keys in ascending order while carrying a parallel `u32` value buffer through the same permutation. Equal keys preserve their input order.
