# compute.kernels.subU32

## Summary
compute.kernels.subU32 subtracts `u32` vectors element by element with results wrapping modulo 2³². It supports prefix counts, a distinct reusable output, and external command recording; otherwise it returns a new readback-capable storage buffer.
