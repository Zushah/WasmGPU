# createScene#getLightingData

## Summary
createScene#getLightingData returns lighting data split into ambient RGB and non-ambient active lights. The light list excludes ambient lights and is capped at `Scene.MAX_LIGHTS`. This is the canonical extraction path used by rendering code.
