# createScene#traverseNodeLinks

## Summary
createScene#traverseNodeLinks iterates through every nodelink currently in the scene. Use this for synchronized graph updates, style changes, or metadata extraction.
