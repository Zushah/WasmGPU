...
## Summary
createCamera.perspective creates a `PerspectiveCamera` for standard 3D rendering with depth foreshortening. By default, rendering keeps its aspect ratio synchronized with the canvas; set `autoAspect: false` to preserve an explicit aspect.
