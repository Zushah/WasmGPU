# createScene#splatFields

## Summary

`createScene#splatFields` returns every `SplatField` attached to the scene, in insertion order. The returned collection includes invisible fields.
...
- [createScene#clearSplatFields](./createscene-clearsplatfields.md)
