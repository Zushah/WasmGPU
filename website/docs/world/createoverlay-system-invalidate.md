# createOverlay.system#invalidate

## Summary
createOverlay.system#invalidate marks overlay state dirty for a specific reason and schedules an update when auto-update is enabled. Call it after external state changes not automatically tracked by the system. This is a lightweight signal method.
