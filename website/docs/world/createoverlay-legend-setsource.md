# createOverlay.legend#setSource

## Summary
createOverlay.legend#setSource switches the legend data source and marks legend state dirty for redraw. Use this when changing point-cloud, glyph, nodelink, or latticespace scalar mappings interactively.
