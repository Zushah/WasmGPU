# createCamera#writeViewMatrixToArray

## Summary
createCamera#writeViewMatrixToArray writes the camera's current column-major world-to-view matrix into an existing numeric array without allocating a replacement matrix.
The optional offset counts elements, and the method returns the same destination after writing 16 values.
