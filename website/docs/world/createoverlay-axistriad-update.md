# createOverlay.axisTriad#update

## Summary
createOverlay.axisTriad#update repositions and redraws triad lines/labels for the current camera and viewport state. In screen-anchor mode it reflects camera orientation; in world-anchor mode it projects world axes from an anchor point. OverlaySystem calls this during update passes.
