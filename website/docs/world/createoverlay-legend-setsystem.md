# createOverlay.legend#setSystem

## Summary
createOverlay.legend#setSystem sets or clears the owning overlay system reference. OverlaySystem invokes this automatically to let the legend invalidate the system when source visuals change.
