# createCamera#setWorldPosition

## Summary
createCamera#setWorldPosition moves a camera to a requested world-space position. For a parented camera, it converts the position into the parent's local space before updating the transform.
...
- [createCamera#transform](./createcamera-transform.md)
