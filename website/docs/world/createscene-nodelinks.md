# createScene#nodeLinks

## Summary
createScene#nodeLinks returns all nodelink objects in the scene, including those not currently visible. Use this collection for graph-specific updates, diagnostics, and object management.
