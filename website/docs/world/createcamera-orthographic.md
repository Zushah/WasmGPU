# createCamera.orthographic

## Summary
createCamera.orthographic creates an `OrthographicCamera` with no perspective foreshortening. It is useful for measurement views, CAD-like interaction, and dense scientific plots where scale consistency matters. You can derive frustum extents directly from canvas size with `updateFromCanvas`.
