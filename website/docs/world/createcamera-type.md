...
## Summary
createCamera#type reports the projection family used by the camera instance. This value is read-only and is either `"perspective"` or `"orthographic"`. Use it when writing camera-agnostic logic that branches on projection behavior.
