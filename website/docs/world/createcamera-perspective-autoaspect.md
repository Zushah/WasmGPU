# createCamera.perspective#autoAspect

## Summary
createCamera.perspective#autoAspect controls whether rendering replaces the camera's aspect ratio with the renderer canvas aspect. The default is `true`.
