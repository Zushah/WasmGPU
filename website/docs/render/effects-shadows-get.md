...
## Summary
effects.shadows.get returns a detached snapshot of one directional light's public shadow configuration.
...
- [effects.shadows.isEnabled](./effects-shadows-isenabled.md)
- [effects.shadows.needsUpdate](./effects-shadows-needsupdate.md)
