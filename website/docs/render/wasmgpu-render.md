...
4. It renders opaque content first. Transmissive `StandardMaterial` objects sample the rendered scene color. Before transparent drawing, each visible splatfield is sorted by camera depth, as are the visible cells of each transparent 3D latticespace.
