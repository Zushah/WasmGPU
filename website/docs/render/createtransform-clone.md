# createTransform#clone

## Summary
createTransform#clone creates a new transform with the same local position, rotation, and scale as the source transform.
The cloned transform is a fresh object with a distinct `index`.
