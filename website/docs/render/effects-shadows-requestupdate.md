# effects.shadows.requestUpdate

## Summary
effects.shadows.requestUpdate marks one or all enabled directional shadow maps dirty so they are regenerated on a later render.
