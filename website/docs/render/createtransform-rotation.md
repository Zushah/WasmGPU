...
## Summary
createTransform#rotation returns the local rotation quaternion.
...
Treat the returned array as read-only. Direct element assignment bypasses normalization, transform-store synchronization, and dirty tracking.
