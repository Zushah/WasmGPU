# effects.shadows.mapSize

## Summary
effects.shadows.mapSize controls the width and height, in pixels, of every directional shadow-map layer. The default is `1024`. Changing it rebuilds shadow resources and marks enabled shadows dirty.
...
## See Also
- [effects.shadows.maxViews](./effects-shadows-maxviews.md)
- [effects.shadows.filter](./effects-shadows-filter.md)
