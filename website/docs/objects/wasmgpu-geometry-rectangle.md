# WasmGPU.geometry.rectangle

## Summary
WasmGPU.geometry.rectangle builds geometry data for a primitive or procedural shape. The returned Geometry can be reused by multiple meshes.
