# createLatticeSpace#colormapStops

## Summary

`createLatticeSpace#colormapStops` contains the custom RGBA stops used when `colormap` is `"custom"`.
...
- [createLatticeSpace#getUniformData](./createlatticespace-getuniformdata.md)
