# gltf.readAccessorAsUint16

## Summary
gltf.readAccessorAsUint16 reads one accessor as compact `Uint16Array` components. Native unnormalized uint16 data returns the raw reader's array and can alias a document buffer; other component types allocate a converted array. This integer conversion does not apply glTF normalized scaling.
