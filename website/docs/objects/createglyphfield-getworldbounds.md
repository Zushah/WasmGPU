# createGlyphField#getWorldBounds

## Summary
createGlyphField#getWorldBounds transforms local bounds by the current world matrix, producing an enclosing world-axis-aligned box while preserving empty/partial status.
