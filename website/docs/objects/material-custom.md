...
## Summary
material.custom creates a caller-WGSL material with an immutable group-1 resource layout. WasmGPU retains its camera/model/global resources in group 0; the declared custom resources occupy group 1.
...
- [material.custom#setResource](./material-custom-setresource.md)
