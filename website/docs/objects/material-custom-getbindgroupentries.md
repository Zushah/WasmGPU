# material.custom#getBindGroupEntries

## Summary
material.custom#getBindGroupEntries validates and converts every declared custom-material resource into WebGPU bind-group entries.
