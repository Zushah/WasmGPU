# createNodeLink#onVisualChange

This page documents the `NodeLink.onVisualChange` method.

## Summary
`createNodeLink#onVisualChange` subscribes to high-level visual changes on the nodelink. The listener receives one of three event kinds:
