# texture.create2D#uploadError

## Summary
texture.create2D#uploadError exposes the terminal error from the most recent asynchronous image decode or GPU upload attempt.
