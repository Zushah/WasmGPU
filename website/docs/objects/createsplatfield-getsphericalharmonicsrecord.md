# createSplatField#getSphericalHarmonicsRecord

## Summary

`createSplatField#getSphericalHarmonicsRecord()` returns one retained flat coefficient record for the active SH degree.
