# createSelectionStore#toggle

## Summary
createSelectionStore#toggle flips membership for each provided hit.
...
- [createSelectionStore#remove](./createselectionstore-remove.md)
