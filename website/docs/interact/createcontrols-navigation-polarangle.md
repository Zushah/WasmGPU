# createControls.navigation#polarAngle

## Summary
createControls.navigation#polarAngle gets or sets the vertical orbit angle (phi) in radians.
...
## See Also
- [createControls.navigation#azimuthAngle](./createcontrols-navigation-azimuthangle.md)
- [createControls.navigation#distance](./createcontrols-navigation-distance.md)
