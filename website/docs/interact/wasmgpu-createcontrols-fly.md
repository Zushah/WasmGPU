...
- [NavigationControls.mode](./wasmgpu-createcontrols-navigation-mode.md)
- [NavigationControls.update](./wasmgpu-createcontrols-navigation-update.md)
- [NavigationControls.dispose](./wasmgpu-createcontrols-navigation-dispose.md)
