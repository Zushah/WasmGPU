# createAnnotation.toolkit#hoverProbe

## Summary
createAnnotation.toolkit#hoverProbe returns the latest hover readout snapshot.
...
- [createAnnotation.toolkit#onHoverReadout](./createannotation-toolkit-onhoverreadout.md)
