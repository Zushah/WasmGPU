# createAnnotation.toolkit#bindPointerTarget

## Summary
createAnnotation.toolkit#bindPointerTarget changes the DOM element that receives annotation pointer events.
...
## See Also
- [createAnnotation.toolkit#setAutoBindPointerEvents](./createannotation-toolkit-setautobindpointerevents.md)
