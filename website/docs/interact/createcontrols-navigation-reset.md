# createControls.navigation#reset

## Summary
createControls.navigation#reset restores the camera pose/projection saved by `saveState()`.
...
## See Also
- [createControls.navigation#saveState](./createcontrols-navigation-savestate.md)
