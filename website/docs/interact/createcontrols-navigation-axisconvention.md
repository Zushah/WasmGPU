# createControls.navigation#axisConvention

## Summary
createControls.navigation#axisConvention gets or sets the world-axis basis used by view solving and spherical mapping.
Changing this value immediately realigns navigation with the current camera under the new convention.
