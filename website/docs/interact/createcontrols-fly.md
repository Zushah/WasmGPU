...
createControls.fly creates `FlyControls`, a free-flight camera controller with keyboard translation, pointer look, roll, wheel-adjusted movement speed, optional pointer lock, damping, and configurable axis conventions.
...
- [createControls.navigation#mode](./createcontrols-navigation-mode.md)
