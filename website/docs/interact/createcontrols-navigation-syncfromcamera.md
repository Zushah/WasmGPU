# createControls.navigation#syncFromCamera

## Summary
createControls.navigation#syncFromCamera makes subsequent navigation continue from the camera's current transform.
...
## See Also
- [createControls.navigation#setCamera](./createcontrols-navigation-setcamera.md)
