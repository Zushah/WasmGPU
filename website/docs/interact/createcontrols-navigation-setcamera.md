# createControls.navigation#setCamera

## Summary
createControls.navigation#setCamera rebinds the controls instance to a different camera.
Active transitions are canceled, the controls adopt the new camera pose, and change listeners are notified.
...
## See Also
- [createControls.navigation#syncFromCamera](./createcontrols-navigation-syncfromcamera.md)
