# createSelectionStore#values

## Summary
createSelectionStore#values returns a snapshot array of current selection entries.
...
The returned array is a new snapshot, but its entries retain the object and nested attribute references stored with each hit.
...
- [createSelectionStore#has](./createselectionstore-has.md)
