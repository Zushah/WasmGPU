# createControls.navigation#setMode

## Summary
createControls.navigation#setMode switches interaction behavior among `orbit`, `trackball`, and `fly`.
The current camera pose is preserved across the mode change.
