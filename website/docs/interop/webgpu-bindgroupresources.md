# webgpu.bindGroupResources

## Summary
webgpu.bindGroupResources normalizes a binding record or entry array into `GPUBindGroupEntry[]`.
...
- [compute.createPipeline#createBindGroup](../compute/compute-createpipeline-createbindgroup.md)
