...
export default {
    name: "kernels-sum-f32-throughput",
    subsystem: "compute",
    type: "throughput",
    unit: "elements/s",
    description: "Steady-state ComputeKernels.sumF32 reduction throughput including command submission and GPU completion.",
    ...
    run(state, { compute }) {
        compute.kernels.sumF32(state.input, { out: state.output });
    },
