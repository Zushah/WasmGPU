...
export default {
    name: "kernels-dot-f32-throughput",
    subsystem: "compute",
    type: "throughput",
    unit: "elements/s",
    description: "Steady-state dotF32 reduction throughput with caller-provided output.",
    ...
    setup({ compute }, size) {
        return {
            ...
            out: compute.createStorageBuffer({ byteLength: 4 })
        };
    },
    run(s, { compute }, size) {
        compute.kernels.dotF32(s.a, s.b, { out: s.out, count: size });
    },
