...
export default {
    name: "kernels-argmax-f32-throughput",
    subsystem: "compute",
    type: "throughput",
    unit: "elements/s",
    description: "Steady-state ComputeKernels.argmaxF32 pair-reduction throughput excluding readback and including GPU completion.",
    ...
    run(state, { compute }) {
        compute.kernels.argmaxF32(state.input, { out: state.output });
    },
