...
export type { GeometryDescriptor, GeometryAttribute, GeometryBoundsDescriptor, GeometryWasmVertexRefreshOptions, GeometryWasmIndexRefreshOptions, GeometryWasmAttributeOptions, GeometryWasmIndexOptions, GeometryWasmSources } from "./graphics/geometry";
