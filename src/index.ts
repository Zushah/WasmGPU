...
export type { GeometryDescriptor, GeometryAttribute, GeometryBoundsDescriptor, GeometryWasmVertexRefreshOptions, GeometryWasmIndexRefreshOptions, GeometryWasmAttributeOptions, GeometryWasmIndexOptions, GeometryWasmAttributeSetOptions, GeometryWasmSources } from "./graphics/geometry";
