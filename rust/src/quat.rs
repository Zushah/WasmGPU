...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn quat_abs(out: u32, q: u32) -> u32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn quat_add(out: u32, q1: u32, q2: u32) -> u32 {
    with_driver_call(|call| unsafe {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn quat_copy(out: u32, q: u32) -> u32 {
    unsafe { copy_f32(out, q, 4) };
    0
}

#[unsafe(no_mangle)]
pub unsafe extern "C" fn quat_dist(q1: u32, q2: u32) -> f32 {
    unsafe {
        let a = read_f32_array::<4>(q1);
        let b = read_f32_array::<4>(q2);
        let dx = a[0] - b[0];
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn quat_distsq(q1: u32, q2: u32) -> f32 {
    unsafe {
        let a = read_f32_array::<4>(q1);
        let b = read_f32_array::<4>(q2);
        let dx = a[0] - b[0];
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn quat_fromAxisAngle(out: u32, axis: u32, angle: f32) -> u32 {
    with_driver_call(|call| unsafe {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn quat_init(out: u32, a: f32, b: f32, c: f32, d: f32) -> u32 {
    with_driver_call(|call| unsafe {
        let o = f32_slice_mut(call, out, 4);
        o[0] = a;
        o[1] = b;
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn quat_invert(out: u32, q: u32) -> u32 {
    with_driver_call(|call| unsafe {
        let a = read_f32_array::<4>(q);
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn quat_isEqual(q1: u32, q2: u32) -> u32 {
    unsafe {
        let a = read_f32_array::<4>(q1);
        let b = read_f32_array::<4>(q2);
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn quat_isNormalized(q: u32) -> u32 {
    unsafe {
        let a = read_f32_array::<4>(q);
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn quat_isZero(q: u32) -> u32 {
    unsafe {
        let a = read_f32_array::<4>(q);
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn quat_mul(out: u32, q1: u32, q2: u32) -> u32 {
    with_driver_call(|call| unsafe {
        let a = read_f32_array::<4>(q1);
        let b = read_f32_array::<4>(q2);
        let mut t = [0.0f32; 4];
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn quat_neg(out: u32, q: u32) -> u32 {
    with_driver_call(|call| unsafe {
        let a = read_f32_array::<4>(q);
        let o = f32_slice_mut(call, out, 4);
        o[0] = -a[0];
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn quat_norm(q: u32) -> f32 {
    unsafe {
        let a = read_f32_array::<4>(q);
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn quat_normalize(out: u32, q: u32) -> u32 {
    with_driver_call(|call| unsafe {
        let a = read_f32_array::<4>(q);
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn quat_normscl(out: u32, q: u32, n: f32) -> u32 {
    with_driver_call(|call| unsafe {
        let a = read_f32_array::<4>(q);
        let qarr = [a[0], a[1], a[2], a[3]];
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn quat_normsq(q: u32) -> f32 {
    unsafe {
        let a = read_f32_array::<4>(q);
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn quat_random(out: u32) -> u32 {
    with_driver_call(|call| unsafe {
        let o = f32_slice_mut(call, out, 4);
        for value in o {
            *value = rand_f32_01();
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn quat_random_range(out: u32, a: f32, b: f32) -> u32 {
    with_driver_call(|call| unsafe {
        let o = f32_slice_mut(call, out, 4);
        for value in o {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn quat_round(out: u32, q: u32) -> u32 {
    with_driver_call(|call| unsafe {
        let a = read_f32_array::<4>(q);
        let o = f32_slice_mut(call, out, 4);
        for i in 0..4 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn quat_scl(out: u32, q: u32, n: f32) -> u32 {
    with_driver_call(|call| unsafe {
        let a = read_f32_array::<4>(q);
        let o = f32_slice_mut(call, out, 4);
        for i in 0..4 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn quat_slerp(out: u32, q1: u32, q2: u32, t: f32) -> u32 {
    with_driver_call(|call| unsafe {
        let a = read_f32_array::<4>(q1);
        let b = read_f32_array::<4>(q2);
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn quat_sub(out: u32, q1: u32, q2: u32) -> u32 {
    with_driver_call(|call| unsafe {
        let a = read_f32_array::<4>(q1);
        let b = read_f32_array::<4>(q2);
        let o = f32_slice_mut(call, out, 4);
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn quat_toRotation(out: u32, q: u32, v: u32) -> u32 {
    with_driver_call(|call| unsafe {
